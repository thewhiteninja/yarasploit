    ...
    rule stager_sysenter_hook_ring0_migrate_start_x86
    {
        meta:
            desc = "Metasploit::windows::x86::stager_sysenter_hook::ring0_migrate_start"
    
        /*
            FC                   | .                    | cld
        FA                   | .                    | cli
        EB1E                 | ..                   | jmp short ring0_migrate_bounce
        */
