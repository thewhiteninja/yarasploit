    ...
    rule single_service_stuff_me3_x86
    {
        ...
        */
        ...
        strings:
            $a   = { 5f e9 ee fd ff ff 58 58 58 58 31 c0 c3 68 49 43 46 00 68 53 45 52 56 89 e1 8d 47 03 6a 00 50 51 68 0b aa 44 52 ff d5 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 01 6a 10 89 e1 6a 00 51 50 68 c6 55 37 7d ff d5 6a 00 68 f0 b5 a2 56 ff d5 57 68 f0 b5 a2 56 ff d5 }
